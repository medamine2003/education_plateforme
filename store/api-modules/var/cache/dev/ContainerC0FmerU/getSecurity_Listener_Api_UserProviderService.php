...
class getSecurity_Listener_Api_UserProviderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.listener.api.user_provider'] = new \Symfony\Component\Security\Http\EventListener\UserProviderListener(($container->privates['security.user.provider.concrete.api_user_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_ApiUserProviderService')));
    }
}
