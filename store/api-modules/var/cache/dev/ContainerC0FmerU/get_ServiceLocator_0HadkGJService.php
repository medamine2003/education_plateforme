 ...
 */
class get_ServiceLocator_0HadkGJService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private '.service_locator.0HadkGJ' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    public static function do($container, $lazyLoad = true)
    {
        return $container->privates['.service_locator.0HadkGJ'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Controller\\API\\ModuleController::index' => ['privates', '.service_locator.TWxDQA4.App\\Controller\\API\\ModuleController::index()', 'getModuleControllerindexService', true],
            'kernel:registerContainerConfiguration' => ['privates', '.service_locator.4wc4Ag1.kernel::registerContainerConfiguration()', 'get_ServiceLocator_4wc4Ag1_KernelregisterContainerConfigurationService', true],
            'kernel:loadRoutes' => ['privates', '.service_locator.4wc4Ag1.kernel::loadRoutes()', 'get_ServiceLocator_4wc4Ag1_KernelloadRoutesService', true],
            'App\\Controller\\API\\ModuleController:index' => ['privates', '.service_locator.TWxDQA4.App\\Controller\\API\\ModuleController::index()', 'getModuleControllerindexService', true],
        ], [
            ...
            'App\\Controller\\API\\ModuleController::index' => '?',
            'kernel:registerContainerConfiguration' => '?',
            'kernel:loadRoutes' => '?',
            'App\\Controller\\API\\ModuleController:index' => '?',
        ]);
